...
def update_data():
    data = pd.read_csv('https://water.usbr.gov/api/web/app.php/api/series?sites=lakepowell&parameters=Day.Inst.ReservoirStorage.af&start=' + ld + '&end=' + ld + '&format=csv', skiprows=4)
    print(data)
